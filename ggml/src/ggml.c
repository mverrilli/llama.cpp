...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    // reserved gap between Q1_0 (41) and KPC4_1 (45); named so range-checked lookups never see a NULL type_name
    [42] = {
        .type_name                = "unused_42",
        .blck_size                = 0,
        .type_size                = 0,
    ...
    [GGML_TYPE_Q3V_1] = {
        .type_name                = "q3v_1",
        .blck_size                = QK3V,
        .type_size                = sizeof(block_q3v_1),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q3v_1,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q3v_1_ref,
    },
    [GGML_TYPE_Q3V_2] = {
        .type_name                = "q3v_2",
        .blck_size                = QK3V2,
        .type_size                = sizeof(block_q3v_2),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q3v_2,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q3v_2_ref,
    },
    [4] = { // GGML_TYPE_Q4_2
...
struct ggml_tensor * ggml_kpc_requant(
    ...
    // op_params: { ng_max } (the scalezp pool count to clamp pool indices)
