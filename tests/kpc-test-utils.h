...
// init the model+context with the kpc4_1/q4_1 cache from argv (caller pre-fills params).
// returns nullptr on parse fail; model()==null -> bail, context()==null -> skip (incompatible head_dim)
